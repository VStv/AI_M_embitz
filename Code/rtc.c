...
{
	rtc_data->s_counter = ((uint32_t)RTC->CNTH << 16) | RTC->CNTL;
}
...
*                  - time jump flag                                     										* 
* Output         : time-struct gets filled, 								                         			*
* Return         : none                                                                              			* 
*****************************************************************************************************************/
void GetTimeRtc	(
				uint32_t rtc_cnt,
...
// -------------------------------- Prepearing data for RTC -----------------------------------
/****************************************************************************************************************
* Function Name  : struct_to_counter                                                                            *
* Description    : calculates the value of the counter based on the values of the fields type structure RTC_t   *
